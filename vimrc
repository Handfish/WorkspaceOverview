"
" Kenny Udovic's Vim Configuration
...
" Syntax Highlighting
  " Support for .tf, .tfvars .tfstate highlighting to HCL, HCL, JSON
Plugin 'hashivim/vim-terraform'
  " Play2/akka framework written in Scala configuration
...
" DfrankUtil is a utility libraray vimprj depends on
  " Vimprj - You need to create in the root directory of 
...
" Double <Leader> movement to jump
Plugin 'EasyMotion'

" Something to do with Camelcasing and Regex
Plugin 'MarcWeber/vim-addon-completion'

" Visblock :I to make a line of incremented numbers
Plugin 'VisIncr'

" Kill buffer without closing split or window
Plugin 'bufkill.vim'
...
" Personal wiki / note taking program
...
function! KennyFugitiveStatusLine()
...
set stl=%f\ %m\ %r%{KennyFugitiveStatusLine()}\ Line:%l/%L[%p%%]\ Col:%v\ Buf:#%n\ [%b][0x%B]
...
"-----------------------------------------------------------------------------
" Sokoban stuff
let g:SokobanLevelDirectory = "/home/kenny/.vim/bundle/vim-sokoban/VimSokoban/"
...
" let g:ctrlp_user_command = 'find %s -type f | grep -v -E "\v[\/](build|node_modules|target|dist|project)|(\.(swp|ico|git|svn|.jar))$"'

let g:ctrlp_custom_ignore = '\v[\/](build|node_modules|target|dist|project)|(\.(swp|ico|git|svn|.jar))$'
...
" EasyTags
"-----------------------------------------------------------------------------
"let g:home_code_dir = '/Users/kenny/code'
